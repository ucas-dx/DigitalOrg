...
class Sam3Image(torch.nn.Module):
    ...
    def forward_grounding(
        ...
        # During pure inference (no targets), skip matching to allow forward_grounding
        # to be used without providing training targets.
        if (self.training or self.num_interactive_steps_val > 0) and find_target is not None:
