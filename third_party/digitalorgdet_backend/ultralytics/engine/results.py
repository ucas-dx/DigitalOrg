...
class Results(SimpleClass, DataExportMixin):
    ...
    def new(self):
        ...
        Returns:
            (Results): A new Results object with duplicated attributes from the original instance.
    ...
    def save_crop(self, save_dir: str | Path, file_name: str | Path = Path("im.jpg")):
        ...
        Notes:
            ...
            - Original image is duplicated before cropping to avoid modifying the original.
        """
        if self.probs is not None:
